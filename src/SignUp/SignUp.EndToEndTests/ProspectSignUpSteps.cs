...
namespace SignUp.EndToEndTests
{
    ...
    public class ProspectSignUpSteps
    {
        ...
        {
            _Driver.FindElement(By.Id("ctl00_MainContent_txtFirstName")).SendKeys(firstName);
            _Driver.FindElement(By.Id("ctl00_MainContent_txtLastName")).SendKeys(lastName);
            _Driver.FindElement(By.Id("ctl00_MainContent_txtEmail")).SendKeys(emailAddress);
            _Driver.FindElement(By.Id("ctl00_MainContent_txtCompanyName")).SendKeys(companyName);

            new SelectElement(_Driver.FindElement(By.Id("ctl00_MainContent_ddlCountry"))).SelectByText(country);
            new SelectElement(_Driver.FindElement(By.Id("ctl00_MainContent_ddlRole"))).SelectByText(role);
        ...
        {
            var goButton = _Driver.FindElement(By.Id("ctl00_MainContent_btnGo"));
            goButton.Click();
        }
